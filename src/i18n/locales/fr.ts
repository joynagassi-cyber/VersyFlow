...
export const fr = {
  ...
  semantic: {
    ...
    subtitle: 'Concepts, versets et communautés',
    concept: 'Concept',
    ...
    primary: 'Principal',
    labels: 'Autres langues',
    noConcepts: 'Aucun concept actif',
    noCommunity: 'Aucune communauté',
    noRelated: 'Aucun lien direct',
    noVerses: 'Aucun verset lié',
    noCrossRefs: 'Aucune référence croisée',
    expected: 'Texte attendu',
    relatedTo: 'Lié à',
  },
  recallWriting: {
    title: 'Écriture de mémoire',
    placeholder: 'Écrivez le verset de mémoire...',
    compare: 'Comparer',
    reset: 'Recommencer',
    matchScore: 'Similarité',
    correct: 'Correct',
    wrong: 'Incorrect',
    missing: 'Manquant',
    extraWords: 'Mots en trop',
  },
  review: {
